...
| human vaginal environmental package | Mandatory | Migs/mims/mimarks extension for reporting of measurements and observations obtained from one or more of the environments where the sample was obtained. All environmental packages listed here are further defined in separate subtables. By giving the name of the environmental package, a selection of fields can be made from the subtables and can be reported |
...
| gynecological disorder | Optional | History of gynecological disorders; can include multiple disorders |
| urogenital disorder | Optional | History of urogenital disorders, can include multiple disorders |
...
| menarche | Optional | Date of most recent menstruation |
| sexual activity | Optional | Current sexual partner and frequency of sex |
| pregnancy | Optional | Date due of pregnancy |
| douche | Optional | Date of most recent douche |
| birth control | Optional | Specification of birth control medication used |
| menopause | Optional | Date of onset of menopause |
| HRT | Optional | Whether subject had hormone replacement theraphy, and if yes start date |
| hysterectomy | Optional | Specification of whether hysterectomy was performed |
