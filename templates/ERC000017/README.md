...
| human skin environmental package | Mandatory | Migs/mims/mimarks extension for reporting of measurements and observations obtained from one or more of the environments where the sample was obtained. All environmental packages listed here are further defined in separate subtables. By giving the name of the environmental package, a selection of fields can be made from the subtables and can be reported |
...
| dermatology disorder | Optional | History of dermatology disorders; can include multiple disorders |
...
| time since last wash | Optional | Specification of the time since last wash. Units: hours, minutes |
| dominant hand | Optional | Dominant hand of the subject |
