...
| completeness software | Optional | Tools used for completion estimate, i.e. checkm, anvi'o, busco |
...
| binning software | Optional | Tool(s) used for the extraction of genomes from metagenomic datasets e.g. concoct and maxbin |
