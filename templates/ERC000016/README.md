...
| human oral environmental package | Mandatory | Migs/mims/mimarks extension for reporting of measurements and observations obtained from one or more of the environments where the sample was obtained. All environmental packages listed here are further defined in separate subtables. By giving the name of the environmental package, a selection of fields can be made from the subtables and can be reported |
...
| nose/mouth/teeth/throat disorder | Optional | History of nose/mouth/teeth/throat disorders; can include multiple disorders |
...
| time since last toothbrushing | Optional | Specification of the time since last toothbrushing. Units: hours, minutes |
